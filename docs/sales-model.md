...
| Display Name | Schema | Type | Required | When populated |
| :---- | :---- | :---- | :---- | :---- |
| Document Type | tavu\_documenttype | Choice (SOW, Proposal, Contract, Estimate, Change Order) | Optional | On creation |
| Version | tavu\_version | Single Line | Optional | On creation (e.g. v1.0, v1.1) |
| Sent Date | tavu\_sentdate | Date Only | Optional | When sent to client |
| Expected Decision Date | tavu\_expecteddecisiondate | Date Only | Optional | When sending |
| Proposal Content | tavu\_content | Multiple Lines (50,000+ chars) | Optional | Narrative body (input/output of future AI Proposal Generator) |
