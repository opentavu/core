...
namespace OpenTavu.Plugins.Common
{
	...
	public class LocalPluginContext
	{
		...
		/// Use this when actions should respect the calling user's security privileges.
		/// </summary>
		...
		/// Output appears in PluginTraceLog table — always trace key checkpoints.
		/// </summary>
		...
		public void Trace(string format, params object[] args)
		{
			...
			// Safely format. If args is null or empty, just emit the raw format string.
