...
namespace OpenTavu.Dataverse.Common
{
    ...
    ///   }
    ///
    /// This file is shared across all OpenTavu projects that consume the
    /// Dataverse SDK (plugins, custom workflow activities, etc.) via "Add as Link".
    /// The physical file lives at: src\_Shared\Common\PluginBase.cs
    /// </remarks>
    public abstract class PluginBase : IPlugin
    {
        ...
        /// Dataverse hard limit is 8; OpenTavu uses 1 by default
        ...
        /// <summary>
        /// Entry point invoked by the Dataverse pipeline.
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                // Infinite-loop guard: if this plugins own update triggers itself,
                ...
                // Delegate to the concrete plugins business logic.
        ...
        /// Receives a fully-built LocalPluginContext so no service extraction is needed.
        /// </summary>
